package com.kcterala.expensetrackerapi.exceptions;

import com.kcterala.expensetrackerapi.entity.ErrorObject;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handleMisMatchException(MethodArgumentTypeMismatchException e, WebRequest request){
        ErrorObject error = new ErrorObject();
        error.setMessage(e.getMessage());
    ...
    public ResponseEntity<ErrorObject> handleItemExistsException(Exception e, WebRequest request){
        ErrorObject error = new ErrorObject();
        error.setMessage(e.getMessage());
